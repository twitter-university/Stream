...
import com.marakana.android.stream.R;
...
ListAdapter {
     ...
     */
    public Drawable getBackgroundDrawable(@SuppressWarnings("unused") final TreeNodeInfo<T> treeNodeInfo) { // NOPMD
        return null;
    }
    ...
    protected Drawable getDrawable(final TreeNodeInfo<T> nodeInfo) {
        ...
        return (nodeInfo.isExpanded()) ? expandedDrawable : collapsedDrawable;
    }
    ...
    @SuppressWarnings("unchecked")
    public void handleItemClick(@SuppressWarnings("unused") final View view, final Object id) {
        expandCollapse((T) id);
    }
