 ...
 *
 * @param <T> type of the identifier for nodes in the tree
 */
public interface TreeStateManager<T> extends Serializable {
     ...
     *
     * @param id id of the node to remove or null if all nodes are to be
     *            removed.
     */
     ...
     *
     * @param id node which children should be expanded. cannot be null (top
     ...
     * all.
     *
     * @param id node which children should be expanded or null if all nodes are
     *            to be expanded.
     */
     ...
     * Collapse children.
     *
     * @param id id collapses everything below node specified. If null,
